...
![Annotate clojure code evaluation!](https://github.com/BetterThanTomorrow/calva/raw/master/assets/howto/evaluate.gif)

See [Calva Top 10 Commands](https://github.com/BetterThanTomorrow/calva/blob/master/etc/calva-top-10-commands.md) for some more things to try.
...
With Calva you also get structural editing using [Paredit](https://github.com/BetterThanTomorrow/calva/blob/master/calva/paredit/README.md) and [formatting](https://github.com/BetterThanTomorrow/calva/blob/master/calva/calva-fmt/README.md).
...
![Disable Mission Control Shortcuts](https://github.com/BetterThanTomorrow/calva/raw/master/assets/mission-control-shortcuts.gif)
