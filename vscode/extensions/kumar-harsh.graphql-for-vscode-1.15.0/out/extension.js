...
function activate(context) {
    ...
    vscode_1.workspace.onDidChangeWorkspaceFolders(createClientForWorkspaces);
}
...
function createClientForWorkspace(folder) {
    ...
    const statusBarItem = new ClientStatusBarItem_1.default(client);
    const subscriptions = [
        client.start(),
        {
            dispose() {
