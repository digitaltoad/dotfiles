 ...
 */
class CrystalCompletionItemProvider extends crystalContext_1.CrystalContext {
    /**
     ...
     */
    pushCompletionMethods(completions) {
     ...
     */
    pushCompletionOther(completions, kind) {
     ...
     */
    createCompletionItem(name, detail, documentation, kind) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (wordRange) {
                ...
                if (word.endsWith(".")) {
                    ...
                    if (!staticFound) {
                        let crystalOutput = yield this.crystalContext(document, position, "completion");
...
exports.CrystalCompletionItemProvider = CrystalCompletionItemProvider;
//# sourceMappingURL=crystalCompletion.js.map