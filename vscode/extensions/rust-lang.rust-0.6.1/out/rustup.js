...
function rustupUpdate(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const { stdout } = yield child_process_1.withWsl(config.useWSL).execFile(config.path, [
                'update',
            ]);
...
function getVersion(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const execFile = child_process_1.withWsl(config.useWSL).execFile;
        const output = yield execFile(config.path, ['--version']);
